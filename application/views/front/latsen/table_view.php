...
<div class="row">
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue">Latsen</h3>
        <h4>
            <a class="btn btn-white btn-default btn-round" href="<?php echo site_url('latsen/add');?>">
        ...
        <div>
            <table id="latsen-table" class="table table-striped table-bordered table-hover" width="100%">
                <thead>
                    <tr>
                        <th>Tempat</th>
                        <th>Materi</th>
...
echo js_asset('latsen/latsen-table.js', 'polkam');
?>
<!-- PAGE CONTENT ENDS -->