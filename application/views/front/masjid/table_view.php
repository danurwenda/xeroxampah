...
<div class="row">
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue">Masjid</h3>
        <h4>
            <a class="btn btn-white btn-default btn-round" href="<?php echo site_url('masjid/add');?>">
                <i class="ace-icon fa fa-plus-circle blue"></i>Tambah
            </a>
            <span class="btn btn-white btn-default btn-round btn-merge disabled" data-toggle="modal" data-target="#masjid-modal-form">
        ...
        <div>
            <table id="masjid-table" class="table table-striped table-bordered table-hover" width="100%">
                <thead>
                    <tr>
                        <th>No</th>
                        <th></th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="blue bigger">Merge Masjid</h4>
            </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 merge-1">
                            <!-- Nama -->
                            <input type="text" class="form-control" name="masjid_name" nm="masjid_name" />
                        </div>
                        <div class="col-md-1 center">
                            <span class="btn btn-white btn-default btn-round swaprow">
                                <i class="ace-icon fa fa-exchange green"></i>
                        ...
                        <div class="col-md-5 merge-2">
                            <!-- Nama -->
                            <input type="text" class="form-control" nm="masjid_name"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 merge-2">
                            <select style="width: 100%" class="form-control kotakab-select2"></select>
                        </div>
                    </div>
                </form>
            </div>
...
echo js_asset('masjid/masjid-table.js', 'polkam');
?>
<!-- PAGE CONTENT ENDS -->