...
<div class="row">
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue"><?php echo isset($edit_id) ? 'Ubah' : 'Tambah'; ?> Teror</h3>
        <div class="row">
            <?php echo form_open('teror', ['class' => 'form-horizontal', 'role' => 'form', 'id' => 'teror_form']); ?>
...
echo js_asset('teror/teror-form.js', 'polkam');
if (isset($edit_id)) {
    echo js_asset('teror/teror-load.js', 'polkam');
    ?>
    <!--load data and populate form-->
    <script>
        $(window).load(function () {
            load_teror(<?php echo $edit_id; ?>);
        });
    </script>
    <?php
}
