...
<div class="row">
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue">Teror</h3>
        <h4>
            <a class="btn btn-white btn-default btn-round" href="<?php echo site_url('teror/add');?>">
        ...
        <div>
            <table id="teror-table" class="table table-striped table-bordered table-hover" width="100%">
                <thead>
                    <tr>
                        <th>Tempat</th>
                        <th>Tanggal</th>
...
echo js_asset('teror/teror-table.js', 'polkam');
?>
<!-- PAGE CONTENT ENDS -->