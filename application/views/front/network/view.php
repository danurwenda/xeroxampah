<style>
    ...
    #net{
        border:steelblue 10px;
    }
</style>
<div class="row">
    <div class="col-xs-12" >
        <h3 class="header smaller lighter blue">Graph Database</h3>
        <div class="row">
            <div class="col-xs-9"  id="net"></div>
            <div class="col-xs-3" id="prop">
...
<?php echo js_asset('d3.v3.min.js', 'polkam'); ?>
<script>
// set up SVG for D3
    var width = 960,
            height = 500,
...
//  - links are always source < target; edge directions are set by 'left' and 'right'.
    var nodes = [
        {id: 0, reflexive: false, name: 'Kalman', type: 'individu'},
        {id: 1, reflexive: true, name: 'MIT', type: 'organisasi'},
        {id: 2, reflexive: false, name: 'Jippo', type: 'individu'}
    ],
            lastNodeId = 2,
            links = [
