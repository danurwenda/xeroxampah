...
<div class="row">
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue"><?php echo isset($edit_id) ? 'Ubah' : 'Tambah'; ?> Lapas</h3>
        <div class="row">
            <?php echo form_open('lapas', ['class' => 'form-horizontal', 'role' => 'form', 'id' => 'lapas_form']); ?>
...
echo js_asset('lapas/lapas-form.js', 'polkam');
if (isset($edit_id)) {
    echo js_asset('lapas/lapas-load.js', 'polkam');
    ?>
    <!--load data and populate form-->
    <script>
        $(window).load(function () {
            load_lapas(<?php echo $edit_id; ?>);
        });
    </script>
    <?php
}
