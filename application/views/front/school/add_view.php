...
<div class="row">
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue"><?php echo isset($edit_id) ? 'Ubah' : 'Tambah'; ?> School</h3>
        <div class="row">
            <?php echo form_open('school', ['class' => 'form-horizontal', 'role' => 'form', 'id' => 'school_form']); ?>
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">Nama :</label>

                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <input type="text" name="school_name" id="name" class="col-xs-12 col-sm-6" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="password2">Kota:</label>
...
echo js_asset('school/school-form.js', 'polkam');
if (isset($edit_id)) {
    echo js_asset('school/school-load.js', 'polkam');
    ?>
    <!--load data and populate form-->
    <script>
        $(window).load(function () {
            load_school(<?php echo $edit_id; ?>);
        });
    </script>
    <?php
}
